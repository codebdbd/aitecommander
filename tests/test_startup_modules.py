...
class TestLoggingSetup(unittest.TestCase):
    ...
    @patch('logging.info')
    def test_setup_logging(self, mock_log_info, mock_exception_handler, mock_app_logger):
    ...
    @patch('logging.info')
    def test_log_system_info_debug_disabled(self, mock_log_info, mock_get_logger):
...
class TestDatabaseInitializer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.db_initializer = DatabaseInitializer(self.mock_database, self.mock_main_window)
    ...
    def test_update_status_message(self):
        ...
        self.mock_main_window.message_label.setText.assert_called_once_with("Test message")
