...
Old database restored.</source>
            <translation type="vanished">Error de conexión a la base de datos: {error}
Se restauró la base de datos anterior.</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>Archivos de datos (*.txt *.md *.markdown *.pdf *.doc *.docx *.docm *.odt *.rtf *.epub *.fb2 *.mobi *.djvu *.xls *.xlsx *.xlsm *.xlsb *.csv *.tsv *.ods *.ppt *.pptx *.odp *.psd *.psb *.ai *.eps *.indd *.indt *.idml *.prproj *.aep *.sesx *.xd *.fla *.dng *.jpg *.jpeg *.png *.gif *.bmp *.webp *.svg *.ico *.tiff *.tif *.raw *.cr2 *.cr3 *.nef *.arw *.heic *.avif *.mp3 *.wav *.flac *.aac *.ogg *.m4a *.wma *.opus *.mp4 *.mkv *.avi *.mov *.wmv *.webm *.flv *.m4v *.zip *.rar *.7z *.tar *.gz *.bz2 *.xz *.iso *.img *.torrent *.json *.xml *.yaml *.yml *.toml *.ini *.cfg *.conf *.log *.sql *.db *.sqlite *.sqlite3 *.html *.htm *.css *.ttf *.otf *.woff *.woff2 *.blend *.obj *.fbx);;Todos los archivos (*.*)</translation>
        </message>
        <message>
...
(Haga clic para cambiar)</translation>
        ...
        <message>
            ...
            <translation type="vanished">Perfil: {name}</translation>
        </message>
        <message>
            <source>Profiles: {first}, {second}</source>
            <translation type="vanished">Perfiles: {first}, {second}</translation>
        </message>
        <message>
            <source>Profiles: {first}, {second} and {rest} more</source>
            <translation type="vanished">Perfiles: {first}, {second} y {rest} más</translation>
        </message>
    </context>
    <context>
        ...
        <message>
            ...
            <translation>Orden de rotación ({count}):</translation>
        </message>
        <message>
            <source>(Click to change)</source>
            <translation>(Haga clic para cambiar)</translation>
...
Are you sure you want to continue?</source>
            <translation>Se eliminarán permanentemente {count} enlace(s) seleccionado(s).
...
¿Está seguro de que desea continuar?</translation>
    ...
    <context>
        ...
        <message>
            <source>Profile selection module is unavailable.</source>
            <translation type="vanished">El módulo de selección de perfiles no está disponible.</translation>
        </message>
        <message>
            <source>Browser profiles</source>
            <translation type="vanished">Perfiles del navegador</translation>
        </message>
        <message>
            <source>Failed to load browser profile selection dialog. Ensure the component is installed and accessible.</source>
            <translation type="vanished">Error al cargar el diálogo de selección de perfiles del navegador. Asegúrese de que el componente esté instalado y accesible.</translation>
        </message>
    </context>
    <context>
...
© MyCompany</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation type="vanished">Introduzca el nombre de la esfera:</translation>
        </message>
    </context>
    <context>
        <name>StatusBar</name>
...
Are you sure you want to continue?</source>
            <translation>Se eliminarán {categories} categoría(s) y {links} enlace(s) en total.
...
Are you sure you want to continue?</source>
            <translation>Las secciones seleccionadas contienen un total de {categories} categoría(s) y {links} enlace(s).
