...
Old database restored.</source>
            <translation type="vanished">Помилка підключення до бази даних: {error}
Стару базу даних відновлено.</translation>
    ...
    <context>
        ...
        <message>
            ...
            <translation>Файли даних (*.txt *.md *.markdown *.pdf *.doc *.docx *.docm *.odt *.rtf *.epub *.fb2 *.mobi *.djvu *.xls *.xlsx *.xlsm *.xlsb *.csv *.tsv *.ods *.ppt *.pptx *.odp *.psd *.psb *.ai *.eps *.indd *.indt *.idml *.prproj *.aep *.sesx *.xd *.fla *.dng *.jpg *.jpeg *.png *.gif *.bmp *.webp *.svg *.ico *.tiff *.tif *.raw *.cr2 *.cr3 *.nef *.arw *.heic *.avif *.mp3 *.wav *.flac *.aac *.ogg *.m4a *.wma *.opus *.mp4 *.mkv *.avi *.mov *.wmv *.webm *.flv *.m4v *.zip *.rar *.7z *.tar *.gz *.bz2 *.xz *.iso *.img *.torrent *.json *.xml *.yaml *.yml *.toml *.ini *.cfg *.conf *.log *.sql *.db *.sqlite *.sqlite3 *.html *.htm *.css *.ttf *.otf *.woff *.woff2 *.blend *.obj *.fbx);;Всі файли (*.*)</translation>
        </message>
        <message>
...
(Натисніть для зміни)</translation>
        ...
        <message>
            ...
            <translation type="vanished">Профіль: {name}</translation>
        </message>
        <message>
            <source>Profiles: {first}, {second}</source>
            <translation type="vanished">Профілі: {first}, {second}</translation>
        </message>
        <message>
            <source>Profiles: {first}, {second} and {rest} more</source>
            <translation type="vanished">Профілі: {first}, {second} та ще {rest}</translation>
        </message>
    </context>
    <context>
    ...
    <context>
        ...
        <message>
            ...
            <translation>Ротація Chrome</translation>
        </message>
        <message>
            ...
            <translation>Обрати профілі...</translation>
        </message>
        <message>
...
За бажанням можна відкрити перші 10 вибраних.</translation>
    ...
    <context>
        ...
        <message>
            <source>Profile selection module is unavailable.</source>
            <translation type="vanished">Модуль вибору профілю браузера недоступний.</translation>
        </message>
        <message>
            <source>Browser profiles</source>
            <translation type="vanished">Профілі браузера</translation>
        </message>
        <message>
            <source>Failed to load browser profile selection dialog. Ensure the component is installed and accessible.</source>
            <translation type="vanished">Не вдалося завантажити діалог вибору профілю браузера. Переконайтеся, що компонент встановлено та доступний.</translation>
        </message>
    </context>
    <context>
