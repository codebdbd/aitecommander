"""Compatibility layer exposing legacy `app.views.base_widgets` API."""

from importlib import import_module
from typing import Any

_TARGET_MODULE = import_module("app.views.widgets.base.base_widgets")
...
def __getattr__(name: str) -> Any:
    ...
    except AttributeError as exc:  # pragma: no cover - совместимость
