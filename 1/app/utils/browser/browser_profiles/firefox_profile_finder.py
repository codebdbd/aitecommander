...
class FirefoxProfileFinder(BaseBrowserProfileFinder):
    ...
    def __init__(self):
        ...
        self.profiles_dir = app_config.get_firefox_profiles_dir()
            ...
            for section_name in config.sections():
                if section_name.startswith('Profile'):
                    ...
                    if os.path.exists(full_path):
                        ...
                        logger.debug(f"Найден профиль Firefox: {name} ({email or 'без email'})")
    ...
    def parse_profile_from_args(self, args: str) -> Optional[Dict]:
        ...
        try:
            ...
            if match:
                ...
                logger.debug(f"parse_profile_from_args: found profile_name={profile_name}")
                result = {
                    "name": profile_name,
