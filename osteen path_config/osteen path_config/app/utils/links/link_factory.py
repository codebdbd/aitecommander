...
def make_link_record(
    name: str, url: str, link_type: str, icon_name: str, notes: str, last_used: Any, position: int,
    category_id: Optional[int], args: str, is_favorite: int, link_id: Optional[int] = None
) -> Dict[str, Any]:
...
def make_profile_link_record(
    link_name: str, url: str, link_type: str, icon_name: str, prof_args: str, notes: str,
    category_id: Optional[int], last_used: Any, position: int, link_id: Optional[int] = None, 
    browser_key: Optional[str] = None
) -> Dict[str, Any]:
