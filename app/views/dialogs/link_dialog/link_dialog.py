"""Compatibility proxy for `app.views.windows.dialogs.link_dialog.link_dialog`."""

from importlib import import_module
from typing import Any

_TARGET_MODULE = import_module("app.views.windows.dialogs.link_dialog.link_dialog")
