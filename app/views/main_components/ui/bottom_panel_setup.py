...
def _label_for_action(action_id: str) -> str:
    if action_id == "launch_marked":
        return QCoreApplication.translate("BottomPanel", MenuStrings.ACTION_LAUNCH_MARKED)
...
def _tooltip_for_action(action_id: str) -> str:
    ...
    if action_id == "launch_marked":
        return QCoreApplication.translate("BottomPanel", DialogStrings.TOOLTIP_LAUNCH_MARKED)
    if action_id == "edit_link":
