...
class MenuTexts:
    ...
    SAVE_DATABASE = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Export Database")
    RESTORE_DATABASE = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Restore Database")
    CONNECT_DATABASE = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Import Database")
    IMPORT_BROWSER = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Import Bookmarks")
    ...
    PASTE_SECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Paste section")
    DELETE_SECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Delete section")
    COPY_CATEGORY = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Copy category")
    COPY_SECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Copy section")
    ...
    CLEAR_SELECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Clear selection")
    # Undo/Redo
    ...
    ADD_NOTE = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Add note")
    # Favorites toggle
    ...
    SHARE_CATEGORY = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Share category")
    SHARE_SECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Share section")
    IMPORT_CATEGORY = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Import category")
    IMPORT_SECTION = QT_TRANSLATE_NOOP(_TR_CONTEXT, "Import section")
